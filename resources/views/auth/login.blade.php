...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form class="auth-form" action="{{ route('userLogin') }}" method="post">
                @csrf
        ...
        <div class="auth-decoration">
            <div class="decoration-content">
                <h2>New here?</h2>
                <p>Join our community and discover amazing features!</p>
                <a href="{{ route('register') }}" class="decoration-btn">Sign Up</a>
