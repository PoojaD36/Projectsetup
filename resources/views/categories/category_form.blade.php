                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="imglink" placeholder="Enter image URL" name="imglink" value="{{old('imglink')}}">
                                </div>
                                <span class="text-danger">@error('imglink'){{$message}} @enderror</span>
                                <div class="mt-2 text-center">
                                    <img id="imagePreview" src="https://via.placeholder.com/300x200?text=Image+Preview" alt="Preview" class="img-thumbnail" style="max-height: 150px; width: auto;">
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="subcategory-table-container">
                            <table class="subcategory-table table table-hover" id="categoriesTable" style="width: 100% !important;" >
                                    ...
                                    @isset($listData)
                                        @if(count($listData) > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $cd->img_link ?? 'https://via.placeholder.com/80?text=No+Image' }}" 
                                                         class="img-thumbnail" 
                                                         style="width: 80px; height: 60px; object-fit: cover;"
                                                         alt="{{ $cd->name }}">
                                                </td>
                                                <td>
                                                    <p class="text-muted mb-0">{{ Str::limit($cd->short_dtls, 50) }}</p>
                                                </td>
                                                <td>
